# This script is modified from https://github.com/DLR-RM/stable-baselines3/blob/master/stable_baselines3/sac/policies.py
...
from stable_baselines3.common.distributions import SquashedDiagGaussianDistribution, StateDependentNoiseDistribution, CategoricalDistribution
...
class Actor(BasePolicy):
    """
    Actor network (policy) for SAC in discrete settings.
    ...
    def __init__(
        ...
        if self.use_sde:
            ...
            # Prevoiusly, sampling contiunuous action from reparametrized Gaussain Dist.

            # self.action_dist = SquashedDiagGaussianDistribution(action_dim)
            # self.mu = nn.Linear(last_layer_dim, action_dim)
            # self.log_std = nn.Linear(last_layer_dim, action_dim)

            # Now, for discrete action, sampling action from Categorical Dist, 
    ...
    def get_action_dist_params(self, obs: th.Tensor) -> Tuple[th.Tensor, th.Tensor, Dict[str, th.Tensor]]:
        ...
        Modified for discrete action in SAC.
...
class SACPolicy(BasePolicy):
    ...
    def make_critic(self, features_extractor: Optional[BaseFeaturesExtractor] = None) -> ContinuousCritic:
        ...
        # ContinuousCritic is capable of accept different size of action input.
